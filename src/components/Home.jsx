...
const Home = () => {
  ...
  return (
    <section className="mt-16 sm:mt-28 flex flex-col mx-auto px-4 sm:px-6 lg:px-8 justify-center text-center">
      <div className="flex flex-col">
        <div className="mt-4" data-aos="fade-down">
          <h3
            ...
            className="text-tertiary text-xs  sm:text-2xl md:text-2xl font-bold tracking-wider sm:tracking-widest"
          >
            ANYA SOFTEK
          </h3>
          <h3
            ...
            className="text-tertiary text-xs tracking-wide sm:tracking-widest  sm:text-2xl md:text-xl  font-bold"
          >
        ...
        >
          <h1
            ...
            className="text-black max-w-5xl  tracking-wide sm:tracking-widest text-2xl sm:text-3xl md:text-6xl font-normal"
            data-aos="fade-down"
          >
      ...
      <div className="mx-auto flex flex-wrap justify-center gap-4 md:gap-8 mt-10 sm:mt-20 mb-10 sm:mb-20">
        {services?.map((service) => (
          <div
            key={service.id}
            className="flex flex-col items-center sm:flex-1 md:w-[25%] transition-transform hover:scale-110"
            data-aos="flip-up"
          >
            <img
              src={service.icon}
      ...
      <div
        className="mx-auto flex flex-wrap justify-center gap-8 mt-15 mb-10 sm:mb-20"
        data-aos="fade-right"
      >
        <HomeEmail />
      </div>
