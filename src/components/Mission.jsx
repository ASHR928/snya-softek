          ...
          <div className="max-w-l text-center md:text-left flex justify-center md:justify-start md:mt-6">
            <RevealFromLeft>
              <p
                ...
                <br /> We understand that every project is a unique opportunity
                to create something extraordinary. From concept to execution, we
            ...
            <RevealFromLeft>
              <CardItem className="flex flex-wrap justify-center">
                <img
                  ...
                  src={frame4}
                  alt="frame4"
                  className="md:max-w-full h-auto md:h-[125px] h-[60px] md:mt-0 mt-2 md:mr-0 mr-2 lg:mt-2  lg:mr-2   lg:mb-0"
                />
                <img
                  style={{
                    borderRadius: "1rem",
