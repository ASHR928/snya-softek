    ...
    <section>
      ...
      <div className="flex md:ml-[110px] md:pb-10">
        <CardContainer className=" flex flex-start border-black">
          <CardBody className="  cardbg   group/card shadow-xl md:w-[350px] justify-center items-center text-center  md:rounded-xl md:pt-[34px] md:pb-[49px] md:pr-[70px] md:pl-[70px] bg-white">
        ...
        <CardContainer className=" flex flex-start border-black">
          <CardBody className="  cardbg   group/card rounded-xl md:ml-10   md:w-[350px] shadow-xl md:pt-[30px] md:pb-[10px] justify-center items-center text-center  md:pr-[40px] md:pl-[40px]">
            <CardItem translateZ="100">
              <div className="flex ">
        ...
        <CardContainer className=" flex flex-start border-black">
          <CardBody className="    group/card cardbg rounded-xl md:ml-10 md:w-[350px] shadow-xl md:pt-[60px] md:pb-[10px]  md:pr-[40px] md:pl-[40px]">
            <CardItem translateZ="100">
