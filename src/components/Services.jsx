            ...
            <motion.div className="flex  justify-center mr-4  ">
              {services2.slice(0, 4).map((service) => (
                <motion.div
                  ...
                  className="flex shadow-lg cursor-pointer justify-center md:pt-[1rem] items-center md:pb-4 text-center flex-col md:w-[80%] w-[50%] md:mr-12 md:pl-[1rem] md:pr-[1rem] border-2"
                >
                  <motion.img
                    layout
                    src={service.icon}
                  ...
                  />
                  <h3 className="md:w-[100px] w-[80%] border-b border-gray-600 text-black font-Montserrat text-lg md:text-xl">
                    {service.title}
                  </h3>
                  {isOpen && (
                    <motion.div>
